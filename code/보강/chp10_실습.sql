...
Customers_Grade_Code : 고객등급코드(코드 (PK), 등급, 기준) 

Employees : 직원(사번 (PK), 이름, 생년월일, 연락처, 급여, 업무코드 (FK), 입사일) 
Job_Code : 업무코드(코드 (PK), 업무) 

Tour_Products : 여행상품(여행번호 (PK), 출발지, 도착지, 프로그램, 시작일시, 종료일시, 최소출발인원, 최대인원, 	여행경비, 예약금, 출발여부, 담당직원사번(FK)) 
'''
...
(1005, '정수민', '010-5555-5555', '광주시 북구', 'G02'),
...
(2001, '김대리', '1988-03-12', '010-9001-0001', 380000, 'J01', '2020-03-01'),
(2002, '박과장', '1983-07-21', '010-9002-0002', 450000, 'J02', '2018-06-15'),
(2003, '이주임', '1992-03-12', '010-9003-0003', 320000, 'J03', '2022-01-10'),
(2004, '최부장', '1979-09-30', '010-9004-0004', 580000, 'J04', '2015-09-01'),
(2005, '정사원', '1998-05-18', '010-9005-0005', 280000, 'J05', '2024-02-01');
...
(3001, '서울', '부산', '부산 해운데 2박3일 여행', '2026-07-01 08:00:00', '2026-07-03 20:00:00',
